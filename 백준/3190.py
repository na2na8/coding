...
class Snake :
    ...
    def move(self, movements, board) :
        ...
        #     for t in range(time-all_time_save) :
        #         head = self.body[self.length-1]
        #         next_head = [head[0] + self.dir[0], head[1] + self.dir[1]]
        #         self.body.insert(0,next_head)
        ...
        # while not(board[self.body[0][0]][self.body[0][1]].status == WALL or board[self.body[0][0]][self.body[0][1]].status == BODY) :
        #     head = self.body[self.length-1]
        #     next_head = [head[0] + self.dir[0], head[1] + self.dir[1]]
        #     self.body.insert(0,next_head)
...
if __name__ == "__main__" :
    ...
    for k in range(K) :
        ...
        row = int(apple_loc[0])+1
        column = int(apple_loc[1])+1
